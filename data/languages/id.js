module.exports = {
  ...
  service: {
    banner: {
      title: 'Pelayanan',
      excerpt:
        'VIAJE, menyediakan layanan Eco-Content seperti bisnis yang berjalan di bidang menyewakan EV Mobilitas, layanan metaverse, dan pembayaran terkait VIA POIN agar banyak orang dapat berkontribusi untuk Perlindungan Lingkungan',
      button: 'Pelajari Lebih',
    },
    introduction: {
    ...
    metaverse: {
      title: 'Metaverse',
      body: 'META VIAJE mengimplementasikan konser K-pop terbesar di Korea yaitu Dream Concert dalam metaverse, tampil secara real time melalui teknologi Motion Capture, dan melakukan pertunjuk an offline dan siaran metaverse secara langsung (Live Broadcast). Kami, Carbon-Free VIAJE ingin mengeluarkan kampanye untuk melindungi lingkungan, Ramah Lingkungan.',
    },
  },
  partnership: {
    banner: {
      title: 'Mitra Kerja',
      excerpt:
        'VIAJE bekerja sama dengan berbagai perusahaan lokal di Bali dan juga perusahaan Korea untuk memperluaskan bisnis secara global dan memberikan layanan terbaik kepada masyarakat ekosistem Carbon-Free VIAJE.',
      button: 'Pelajari Lebih',
    },
    partners: {
      title: 'Mitra Kerja Carbon-Free VIAJE',
    },
  },
  contact: {
    banner: {
